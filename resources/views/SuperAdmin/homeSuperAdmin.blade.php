...
<body>
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">QSU-FMAS</span> </a>
                <div class="nav_list"> 
            ...
            </div> <form method="POST" action="{{ route('logout') }}" id="logout-form">
    @csrf
